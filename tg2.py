...
questions = [
    ...
    {"q": "По какому из анастомозов эмбол может попасть в бассейн глазной артерии?", "options": ["Глубокая височная — скуловисочная", "Поперечная артерия лица — подглазничная", "Угловая — подглазничная"], "answer": "Глубокая височная — скуловисочная"},
...
async def show_confirm_data(message: types.Message, state: FSMContext):
    ...
    text = (
        ...
        "Если хотите что-то изменить, нажмите на соответствующие кнопки.\n"
